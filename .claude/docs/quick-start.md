...
```
.claude/
├── agents/           # Specialized AI assistants (14 total)
│   ├── product/      # Product & planning agents
│   ├── engineering/  # Dev agents (Hono, DB, React, etc.)
│   ├── quality/      # QA & debugging agents
│   ├── design/       # UI/UX & content agents
│   └── specialized/  # Niche expertise (i18n, tech-writer, SEO)
...
**Process:** 4-phase workflow (Planning → Implementation → Validation →
Finalization)
...
**Guides:** [phase-1-planning.md](workflows/phase-1-planning.md) through
[phase-4-finalization.md](workflows/phase-4-finalization.md)
...
- Documentation validation: May show warnings (expected if READMEs not updated
  yet)
