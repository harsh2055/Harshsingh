...
This document lists all MCP (Model Context Protocol) servers integrated into the
Hospeda project and how to use them.
...
**✅ Active:** 19/21 servers installed and configured **⏸️ Pending:** 2 servers
(DeepL, Semgrep)
...
**Status:** Active **Type:** HTTP **Purpose:** Library documentation access and
intelligent caching
...
**Status:** Pending installation **Type:** STDIO **Purpose:** Static code
security analysis
